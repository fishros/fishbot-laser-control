...
if __name__=='__main__':
    # driver = LaserDriver(type="serial",serial_port='/dev/ttyACM0')
    driver = LaserDriver(type="tcp",tcp_port=8848)
    driver.start()
    driver.run_server()
